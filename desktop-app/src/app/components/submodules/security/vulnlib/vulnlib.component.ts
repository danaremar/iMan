...
export class VulnlibComponent extends ImanSubmodule implements OnInit {
    ...
    ***************************/
    ...
    constructor(effortService: EffortService, kanbanService: KanbanService, sprintService: SprintService, projectService: ProjectService, formBuilder: FormBuilder, tokenService: TokenService, private userService: UserService, public vulnLibService: VulnLibService) {
